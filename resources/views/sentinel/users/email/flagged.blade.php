...
@section('content')
    ...
    <ul class="breadcrumb push-down-0">
        ...
        <li><a href="{{ route("email.flagged") }}" class="active">Destacados</a></li>
    </ul>
    <!-- END BREADCRUMB -->
    ...
    <div class="content-frame">
        ...
        <div class="content-frame-top">
            <div class="page-title">
                <h2><span class="fa fa-star"></span> Destacados <small>({{ count($emailList) }})</small></h2>
            </div>
        ...
        <div class="content-frame-left">
            ...
            <div class="block">
                <div class="list-group border-bottom">
                    ...
                    <a href="{{ route('email.flagged') }}" class="list-group-item active"><span class="fa fa-flag"></span> Destacados <span class="badge badge-warning">{{ count($emailList) }}</span></a>
                        ...
                        <?php $message = $mailbox->getMessage($index)->keepUnseen()?>
                            <div class="data-block"
                                ...
                                <div class="mail-item  @if($message->isSeen()) mail-success @else mail-unread mail-info @endif">
                                    ...
                                    <a href="{{  $message->getNumber() }}?mailbox=INBOX" class="mail-text">{{ $message->getSubject() }}</a>
