...
var site_settings = '<div class="ts-button">'
    ...
    +'<div class="ts-body">'
        ...
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_fixed" value="0" /> Fixed Sidebar</label>'
        +'</div>'
        +'<div class="ts-row">'
            +'<label class="check"><input type="checkbox" class="icheckbox" name="st_sb_scroll" value="0"/> Scroll Sidebar</label>'
        +'</div>'
        +'<div class="ts-row">'
        ...
        +'<div class="ts-themes">'
            +'<a href="#" class="active" data-theme="css/theme-default.css"><img src="http://sistemaqh.com/img/themes/default.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-forest.css"><img src="http://sistemaqh.com/img/themes/forest.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-dark.css"><img src="http://sistemaqh.com/img/themes/dark.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-night.css"><img src="http://sistemaqh.com/img/themes/night.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-serenity.css"><img src="http://sistemaqh.com/img/themes/serenity.jpg"/></a>'
            
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-default-head-light.css"><img src="http://sistemaqh.com/img/themes/default-head-light.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-forest-head-light.css"><img src="http://sistemaqh.com/img/themes/forest-head-light.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-dark-head-light.css"><img src="http://sistemaqh.com/img/themes/dark-head-light.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-night-head-light.css"><img src="http://sistemaqh.com/img/themes/night-head-light.jpg"/></a>'
            +'<a href="#" data-theme="http://sistemaqh.com/css/theme-serenity-head-light.css"><img src="http://sistemaqh.com/img/themes/serenity-head-light.jpg"/></a>'

        +'</div>'
        +'<div id="ts-wallpapers">'
        +'<div class="ts-title">Wallpapers</div>'
            +'<div class="ts-themes">'
                +'<a href="#" class="active" data-wall="wall_1"><img src="http://sistemaqh.com/img/backgrounds/wall_1.jpg"/></a>'
                +'<a href="#" data-wall="wall_2"><img src="http://sistemaqh.com/img/backgrounds/wall_2.jpg"/></a>'
                +'<a href="#" data-wall="wall_3"><img src="http://sistemaqh.com/img/backgrounds/wall_3.jpg"/></a>'
                +'<a href="#" data-wall="wall_4"><img src="http://sistemaqh.com/img/backgrounds/wall_4.jpg"/></a>'
                +'<a href="#" data-wall="wall_5"><img src="http://sistemaqh.com/img/backgrounds/wall_5.jpg"/></a>'

                +'<a href="#" data-wall="wall_6"><img src="http://sistemaqh.com/img/backgrounds/wall_6.jpg"/></a>'
                +'<a href="#" data-wall="wall_7"><img src="http://sistemaqh.com/img/backgrounds/wall_7.jpg"/></a>'
                +'<a href="#" data-wall="wall_8"><img src="http://sistemaqh.com/img/backgrounds/wall_8.jpg"/></a>'
                +'<a href="#" data-wall="wall_9"><img src="http://sistemaqh.com/img/backgrounds/wall_9.jpg"/></a>'
                +'<a href="#" data-wall="wall_10"><img src="http://sistemaqh.com/img/backgrounds/wall_10.jpg"/></a>'
            +'</div>'
        +'</div>'
    +'</div>';
